...
This workspace provides a minimal Ubuntu latest base Linux operating system image with fishOS branding, a default Xfce desktop profile, the fish shell package, a Calamares installer experience, a GRUB boot configuration, and an ISO build workflow.
